...
import org.eclipse.equinox.http.jetty.internal.*;
...
public class MyActivator extends Activator implements BundleActivator {
	...
	private static MyHttpServerManager staticServerManager;

	private MyHttpServerManager httpServerManager;
	...
	public void start(BundleContext context) throws Exception {
		...
		httpServerManager = new MyHttpServerManager(jettyWorkDir);
	...
	private synchronized static void setStaticServerManager(MyHttpServerManager httpServerManager) {
